...
class HomemAranha(Sprite):  # criamos o primeiro sprint que irá compor o jogo, o objeto principal.
    def __init__(self, teia):
        ...
        self.image = load('images/luffy.png')  # carrego a imagem e em seguida tranfiro para uma variável.
...
class Inimigo(Sprite):  # criamos o segundo sprint que irá compor o jogo.
    def __init__(self):
        ...
        self.image = load('images/kaido.png')
        self.rect = self.image.get_rect(
...
def interactions(type):
    if type == 1:
        ...
        placard_fase1 = font.render("KAIDO DERROTOU VOÇÊ",
                                    True, (252, 7, 3))
        rect = pygame.Rect(300, 300, 0, 0)
        superficie.blit(placard_fase1, rect)
    elif type == 2:
        font = pygame.font.SysFont("arial", 30, True, False)
        placard_fase1 = font.render("VOÇÊ ENCONTROU O ONE PIECE!",
                                    True, (60, 219, 11))
        rect = pygame.Rect(300, 300, 0, 0)
        superficie.blit(placard_fase1, rect)
